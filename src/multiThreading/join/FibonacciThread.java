    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numbers.size(); i++) {
            ...
            if (fibonacciThread.isFinished)
                System.out.println("Main thread says that thread " + fibonacciThread.getName() + " has finished calculating fib series of " + numbers.get(i));
            else
                System.out.println("Main thread says that thread " + fibonacciThread.getName() + " has not finished calculating fib series of " + numbers.get(i));
        }
    }
}
